...
const gitImg = new URL("../assets/git.png", import.meta.url).href
...
<template>
        ...
        >
            <div v-if="darkmode" class="relative w-auto mx-auto max-w-2xl">
                ...
                <div class="border-0 rounded-lg shadow-lg md:scroll-auto md:flex md:flex-col w-full bg-slate-700 outline-none focus:outline-none">
                    ...
                    <div class="flex items-center justify-between p-6 border-t border-solid border-slate-200 rounded-b">
                        <a href="https://github.com/kellyjellykitten/wordingo" target="_blank"><img alt="Source Code" class="w-11 h-11 object-left hover:animate-spin" title="View Source Code on GitHub" src="../assets/gitlight.png"></a>
            ...
            <div v-if="!darkmode" class="relative w-auto my-6 mx-auto max-w-6xl">
                ...
                <div class="border-0 rounded-lg shadow-lg relative md:flex md:flex-col w-full bg-white outline-none focus:outline-none">
                    ...
                    <!-- footer -->
                    <div class="flex items-center justify-between p-6 border-t border-solid border-slate-200 rounded-b">
                        <a href="https://github.com/kellyjellykitten/wordingo" target="_blank"><img alt="Source Code" class="w-11 h-11 object-left hover:animate-spin" title="View Source Code on GitHub" src="../assets/git.png"></a>
                        <button class="text-green-600 bg-transparent border border-solid border-green-600 hover:bg-green-600 hover:text-white active:bg-green-700 font-bold uppercase text-sm px-6 py-3 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" @click="isOpen = false">
                            Ok, let's play!
                        </button>
                    </div>
    ...
    <div v-else class="text-4xl font-bold tracking-wide text-green-600 hover:animate-spin">
        Wordingo
    </div>
